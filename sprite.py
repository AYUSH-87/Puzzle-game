...
class Tile(pygame.sprite.Sprite):
    ...
    def update(self):
        self.rect.x = self.x * TILESIZE + 20  # Left padding
        self.rect.y = self.y * TILESIZE + 20  # Top padding

    def click(self, mouse_x, mouse_y):
        return self.rect.collidepoint(mouse_x, mouse_y)

    def right(self):
        return self.x + 1 < self.game.grid_size
    ...
    def down(self):
        return self.y + 1 < self.game.grid_size
